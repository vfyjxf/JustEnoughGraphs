...
public class ResourceNineSliceTexture {
    ...
    public ResourceNineSliceTexture(JeghTextureManager jeghTextureManager, ResourceLocation location, int width, int height, int left, int right, int top, int bottom) {
